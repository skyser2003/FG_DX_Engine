...
namespace FG
{
	...
	bool FontShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
	{
		...
		result = InitializeShader(device, hwnd, "../../DxCanvas/DxCanvas/vsfont.hls", "../../DxCanvas/DxCanvas/psfont.hls");
		if (!result)
		{
			return false;
		}
	...
	bool FontShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const char* vsFilename, const char* psFilename)
	{
		HRESULT result;
		...
		result = D3DX11CompileFromFile(vsFilename, nullptr, nullptr, "FontVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, nullptr,
		...
		result = D3DX11CompileFromFile(psFilename, nullptr, nullptr, "FontPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, nullptr,
